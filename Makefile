...
$(ANALYSE): $(ANALYSE_TARGET_DIR)/2018.js $(ANALYSE_TARGET_DIR)/2017.js $(ANALYSE_TARGET_DIR)/2016.js $(ANALYSE_TARGET_DIR)/2015.js $(ANALYSE_TARGET_DIR)/2014.js $(ANALYSE_TARGET_DIR)/2013.js $(ANALYSE_TARGET_DIR)/2012.js $(ANALYSE_TARGET_DIR)/2011.js $(ANALYSE_TARGET_DIR)/2010.js $(ANALYSE_TARGET_DIR)/2009.js $(ANALYSE_TARGET_DIR)/2008.js $(ANALYSE_TARGET_DIR)/2007.js $(ANALYSE_TARGET_DIR)/2006.js $(ANALYSE_TARGET_DIR)/2005.js $(ANALYSE_TARGET_DIR)/2004.js $(ANALYSE_TARGET_DIR)/2003.js $(ANALYSE_TARGET_DIR)/2002.js
	mkdir -p $(TOUCH_DIR)
	touch $@

$(ANALYSE_TARGET_DIR)/2018.js: node_modules data/pfr/2018.csv data/pfr/2017.csv data/pfr/2016.csv data/pfr/2015.csv $(ANALYSE_FILES) index.js
	mkdir -p $(ANALYSE_TARGET_DIR)
	node index.js -p data/pfr/ -s 2018
