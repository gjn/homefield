...
ExponentialMovingAverageAnalyser.prototype.analyse = function(games) {
    ...
    //doing averages of home and away games
    //TODO: move this into analyseGame, to have it after each
    //single game
    var home = this.getTeamStats('home');
    var away = this.getTeamStats('away');
    var that = this;
    _.each(home, function(teamhomestat, team) {
        var teamawaystat = away[team];
