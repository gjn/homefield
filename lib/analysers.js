...
var getNewValues = function(gamestats, oppgamestats, oppemas, emas) {
    ...
    get(gamestats, oppemas.def, emas.off, results.stat.off, results.oppstat.def);
    get(oppgamestats, oppemas.off, emas.def, results.stat.def, results.oppstat.off);
    return results;
};
...
ExponentialMovingAverageAnalyser.prototype.analyseGame = function(game) {
    ...
    var calculate = function(homestat, awaystat, ht, at, alpha) {
    ...
    calculate(game.homestat, game.awaystat, hstat, astat, this.alpha);
