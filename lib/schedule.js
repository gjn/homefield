...
var getStrenghtOfSchedule = function(SOS, games, stats) {
    ...
    _.each(games, function(game) {
      ...
      if (stats.teamstats.away[game.awayteam].stat) {
        HT.sum += stats.teamstats.away[game.awayteam].stat.off.homefield;
        AT.sum += stats.teamstats.home[game.hometeam].stat.off.homefield;
      } else {
        HT.sum += stats.teamstats.away[game.awayteam].s.o.h;
        AT.sum += stats.teamstats.home[game.hometeam].s.o.h;
      }
    });
